...
THUNDER_TRAVIS_DATABASE_CONTAINER=${THUNDER_TRAVIS_DATABASE_CONTAINER:-mariadb}

THUNDER_TRAVIS_DATABASE_VERSION=${THUNDER_TRAVIS_DATABASE_VERSION:-10.3}

THUNDER_TRAVIS_DATABASE_HOST=${THUNDER_TRAVIS_DATABASE_HOST:-${THUNDER_TRAVIS_HOST}}

THUNDER_TRAVIS_DATABASE_PORT=${THUNDER_TRAVIS_DATABASE_PORT:-33006}
...
THUNDER_TRAVIS_DATABASE_ROOT_PASSWORD=${THUNDER_TRAVIS_DATABASE_ROOT_PASSWORD:-root}
