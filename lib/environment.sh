...
THUNDER_TRAVIS_PHP_VERSION=${THUNDER_TRAVIS_PHP_VERSION:-${TRAVIS_PHP_VERSION}}
...
THUNDER_TRAVIS_DRUPAL_INSTALLATION_DIRECTORY=${THUNDER_TRAVIS_DRUPAL_INSTALLATION_DIRECTORY:-/tmp/${THUNDER_TRAVIS_PROJECT_NAME}/test-install}
...
THUNDER_TRAVIS_LOCK_FILES_DIRECTORY=${THUNDER_TRAVIS_LOCK_FILES_DIRECTORY:-/tmp/${THUNDER_TRAVIS_PROJECT_NAME}/finished-stages}
