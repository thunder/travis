...
_stage_prepare_build() {
    ...
    composer config repositories.0 composer https://asset-packagist.org --working-dir="${DRUPAL_TRAVIS_DRUPAL_INSTALLATION_DIRECTORY}"
    composer config repositories.1 path "${DRUPAL_TRAVIS_PROJECT_BASEDIR}" --working-dir="${DRUPAL_TRAVIS_DRUPAL_INSTALLATION_DIRECTORY}"
    composer config repositories.2 composer https://packages.drupal.org/8 --working-dir="${DRUPAL_TRAVIS_DRUPAL_INSTALLATION_DIRECTORY}"
